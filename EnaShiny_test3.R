...
############# Building the network plot 
  ...
  ### Construction des objets sources et target � partir de la matrice des flux
...
####============================ Building the enaR model (NEA Format)
Ena_inputs_NEA_function<- function (model_test){
...
####============================ Table of main outputs of enaR (NEA Format)

Ena_mainOutputs_NEA_function<- function (model_test){
...
####============================ Write ENA outputs
write_ENA_function<- function (flow, input, export, respiration, storage, living){
  ...
  write.nea(model_test, file.name="model_NEA_format.csv")
}
